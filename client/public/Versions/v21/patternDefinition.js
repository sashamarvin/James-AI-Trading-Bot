...
if (patternData.harmonicsPoints.length > 0) {
    ...
    document.getElementById("drawPatternStatus").innerText = patternData.patternPoints.length ? "✅" : "--";
    document.getElementById("breakoutLineStatus").innerText = patternData.breakoutPoints.length ? "✅" : "--";
    document.getElementById("stopLineStatus").innerText = patternData.stopPoints.length ? "✅" : "--";
    document.getElementById("harmonicsLineStatus").innerText = patternData.harmonicsPoints.length ? "✅" : "--";
    document.getElementById("volDryUpStatus").innerText = patternData.volDryUpMarkers.length ? "✅" : "--";
    document.getElementById("shakeoutStatus").innerText = patternData.shakeoutMarkers.length ? "✅" : "--";
    document.getElementById("followthruStatus").innerText = patternData.followThruMarkers.length ? "✅" : "--";
    document.getElementById("buyStatus").innerText = patternData.buyMarkers.length ? "✅" : "--";
    document.getElementById("sellStatus").innerText = patternData.sellMarkers.length ? "✅" : "--";
