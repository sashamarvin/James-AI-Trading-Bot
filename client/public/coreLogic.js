...
let insideDayMarkers = [];
let earningsDayMarkers = [];
...
let harmonicsPoints = [];
let harmonicsPreviewLine = null;
let harmonicsTrendlines = [];
let harmonicsTempPoints = [];
let harmonicsTempLine = [];
let measurePoints = [];
...
let leftDay = null;
let rightDay = null;
let zigZagPoints = []; // Stores points for zig-zag line
...
async function loadRealStockData() {
    ...
    calculateAndPlotEma50(stockData, chart, allSeries);
